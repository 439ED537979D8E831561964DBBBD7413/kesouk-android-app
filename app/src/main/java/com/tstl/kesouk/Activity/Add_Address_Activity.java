        ...
        mCity_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!TextUtils.isEmpty(country_code_lib)) {
                    final ProgressDialog progressDialog = new ProgressDialog(Add_Address_Activity.this);
...
*/
        ...
        mSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ((!(mFirstName.getText().toString().isEmpty() || mLastName.getText().toString().isEmpty() || mMobile.getText().toString().isEmpty() || mHouse.getText().toString().isEmpty() || mCity.getText().toString().isEmpty() || mArea.getText().toString().isEmpty())))
                {
                        ...
                        if (SplashActivity.isNetworkAvailable(Add_Address_Activity.this)) {
                            strNickname=mNickname.getText().toString();
                            strFirstname=mFirstName.getText().toString();
                            strLastname=mLastName.getText().toString();
                            strMobile=mMobile.getText().toString();
                            strHouse=mHouse.getText().toString();
                            strCity=mCity.getText().toString();
                            strResident=mResident.getText().toString();
                            strArea=mArea.getText().toString();
                            strStreet=mStreet.getText().toString();
                            strLandmark=mLandmark.getText().toString();
                    ...
                    Toast.makeText(Add_Address_Activity.this, "Please enter all the details ", Toast.LENGTH_LONG).show();
    ...
    private int getIndex(Spinner spinner, String myString) {
        ...
        for (int i = 0; i < spinner.getCount(); i++) {
            Object temp = spinner.getItemAtPosition(i);
            if (temp != null && temp.equals(myString)) {
                index = i;
            }
        }
        return index;
    ...
    private void addAddress() {
        ...
        params.put("country_code", String.valueOf(country_code));
        params.put("customer_id",  db.getAllLogin().get(0));
        // params.put("id","191");

        if (temp == 1) {
            params.put("id", add_id);
            Log.e("id", add_id);
            temp = 0;
        }

        Log.e("first_name", mFirstName.getText().toString());
        Log.e("last_name", mLastName.getText().toString());
        Log.e("contact_no", mMobile.getText().toString());
        Log.e("country_code", String.valueOf(country_code));
        // Log.e("customer_id", login_credentials.getCustomer_Id());
        //Log.e("id",login_credentials.getAddId());


        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.POST,
                Constants.FORGET_PASSWORD, new JSONObject(params),
                        ...
                        try {
                            ...
                            if (status.equals("Success")) {
                                ...
                                finish();
                                    ...
                                    Intent intent = new Intent(Add_Address_Activity.this, Register_Activity.class);
                                ...
                                Toast.makeText(Add_Address_Activity.this, reason, Toast.LENGTH_LONG).show();
            ...
            public void onErrorResponse(VolleyError volleyError) {
                ...
                if (volleyError instanceof TimeoutError) {
                    Toast.makeText(Add_Address_Activity.this, "Connection was timeout. Please check your internet connection ", Toast.LENGTH_LONG).show();
                } else
                    Toast.makeText(getApplicationContext(), "Please check your internet connection or server is not connected", Toast.LENGTH_LONG).show();
...
*/
                                   ...
                                   // }
                                    ...
                                    if ( !items.isEmpty()) {
                                        spinnerDialog = new SpinnerDialog(Add_Address_Activity.this, items, "Select City");// With No Animation
                    ...
                    public void onResponse(JSONObject object) {
                        try {
                            ...
                            if ( !areaArrayList.isEmpty()) {
                                spinnerDialog = new SpinnerDialog(Add_Address_Activity.this, areaArrayList, "Select City");// With No Animation
                                spinnerDialog.bindOnSpinerListener(new OnSpinerItemClick() {
                                    @Override
                                    public void onClick(String item, int position) {
                                        //Toast.makeText(Register_Activity.this, item + "  " + position+"", Toast.LENGTH_SHORT).show();
