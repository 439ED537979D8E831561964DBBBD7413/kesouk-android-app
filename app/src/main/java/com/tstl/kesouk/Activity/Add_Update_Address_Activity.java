...
public class Add_Update_Address_Activity extends AppCompatActivity {
...
*/
        ...
        mToolbarTitle.setText("UPDATE ADDRESS");
        ...
        mCity_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!TextUtils.isEmpty(country_code_lib)) {
                    final ProgressDialog progressDialog = new ProgressDialog(Add_Update_Address_Activity.this);
        ...
        mSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ((!(mFirstName.getText().toString().isEmpty() || mLastName.getText().toString().isEmpty() || mMobile.getText().toString().isEmpty() || mHouse.getText().toString().isEmpty() || mCity.getText().toString().isEmpty() || mArea.getText().toString().isEmpty())))
                {
                    ...
                    if (SplashActivity.isNetworkAvailable(Add_Update_Address_Activity.this)) {
                    ...
                    Toast.makeText(Add_Update_Address_Activity.this, "Please enter all the details ", Toast.LENGTH_LONG).show();
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.POST,
            ...
            public void onErrorResponse(VolleyError volleyError) {
                ...
                if (volleyError instanceof TimeoutError) {
                    Toast.makeText(Add_Update_Address_Activity.this, "Connection was timeout. Please check your internet connection ", Toast.LENGTH_LONG).show();
                } else
                    Toast.makeText(getApplicationContext(), "Please check your internet connection or server is not connected", Toast.LENGTH_LONG).show();
...
*/
                                    ...
                                    if ( !items.isEmpty()) {
                                        spinnerDialog = new SpinnerDialog(Add_Update_Address_Activity.this, items, "Select City");// With No Animation
                    ...
                    public void onResponse(JSONObject object) {
                        try {
                            ...
                            if ( !areaArrayList.isEmpty()) {
                                spinnerDialog = new SpinnerDialog(Add_Update_Address_Activity.this, areaArrayList, "Select City");// With No Animation
                                spinnerDialog.bindOnSpinerListener(new OnSpinerItemClick() {
                                    @Override
                                    public void onClick(String item, int position) {
                                        //Toast.makeText(Register_Activity.this, item + "  " + position+"", Toast.LENGTH_SHORT).show();
