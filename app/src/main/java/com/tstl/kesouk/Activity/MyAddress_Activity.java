                   ...
                   // itemViewHolder .relativeLayout.setBackgroundDrawable(getResources().getDrawable(R.drawable.border_selector));
                    ...
                    itemViewHolder.mEdit.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            Bundle mBundle = new Bundle();
                            mBundle.putString("one", login_credentials.getFirstname());
                            mBundle.putString("two", login_credentials.getLastname());
                          //  mBundle.putString("three", email);
                           // mBundle.putString("four", login_credentials.getCountry_code());
                            mBundle.putString("five", login_credentials.getContact());
                          //  mBundle.putString("six", login_credentials.getCountry());
                            mBundle.putString("seven", login_credentials.getCity());
                          //  mBundle.putString("eight", login_credentials.getDistrict());
                          //  mBundle.putString("nine", login_credentials.getLocation());
                           // mBundle.putString("ten", login_credentials.getAddId());
                            intent.putExtras(mBundle);
                            startActivity(intent);
                        }
                    });
